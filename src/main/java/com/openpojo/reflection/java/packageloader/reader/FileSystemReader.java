...
public class FileSystemReader {
    ...
    private static File getDirectory(URL url) {
        ...
        if (!directory.exists() || !directory.isDirectory())
            throw ReflectionException.getInstance("Failed to retrieve entries in path: [" + directory.getAbsolutePath() + "] " + "created from URI: [" + urlToFileSystemAdapter.getAsURI() + "].  Please report this issue @ http://openpojo.com");
        return directory;
    }
