...
public class DefaultRandomGeneratorService implements RandomGeneratorService {
    ...
    private final Map<Class<?>, ParameterizableRandomGenerator> concreteParameterizableRandomGenerators = new HashMap<Class<?>, ParameterizableRandomGenerator>();
    ...
    private RandomGenerator getAppropriateRandomGenerator(Class<?> type, Map randomGenerators) {
        ...
        if (appropriateRandomGenerator == null) {
            ...
            if (assignableTypes.size() == 0) {
                ...
                appropriateRandomGenerator = new RandomGeneratorAdapter(type, adaptToType, (RandomGenerator) randomGenerators.get(adaptToType));
            }
        }
